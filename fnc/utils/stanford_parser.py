...
class StanfordMethods:
    ...
    def store_pickle_file(self):
        print('The save-function for stanford information has been disabled, because it currently does not handle different corpora')
        print('See fnc/utils/stanford_parser.py line 38 ff')
